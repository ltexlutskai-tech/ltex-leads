...
тригери, властивості, часові пояси) в один текстовий файл на Диску й пише в
журнал посилання на нього. Файлом можна просто поділитись. Токени у файл не
потрапляють — для них пишеться лише «задано». `tgDiagCleanup()` прибирає старі
файли, лишаючи три найсвіжіші.
