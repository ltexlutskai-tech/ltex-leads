...
Типово клієнт отримує **пряме запрошення в канал** — один крок, нічого зайвого.
Мінус у публічному каналі: Telegram відкриває сам канал, підписка відбувається
повз запрошення, і хто саме прийшов — невідомо (див. наступний розділ).
