...
рядку посилання і скільки записів за цей час у лозі. **Рядок без примітки —
це не кнопка.** Так буває у трьох випадках: менеджер вибрав статус зі списку
у своєму файлі (тригер кожні 15 хв підтягує його в головну), запускали
`restoreTgStatusesFromLog()`, або значення вписали в клітинку руками.
