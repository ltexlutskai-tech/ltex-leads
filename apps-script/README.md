...
сотні мертвих посилань. Адреса береться один раз і запамʼятовується
(`TG_PUBLIC_LINK`), тож клік до Telegram уже не звертається.
...
Звірка не чіпає рядки, де вже стоїть «👤 Приєднався», і обмежена бюджетом
часу — решту довіряє наступному запуску.
