...
Якщо треба знати напевно, хто з клієнтів прийшов, канал має бути приватним:
тоді іншого входу, крім запрошення, просто немає. Це рішення не технічне —
публічний канал знаходять у пошуку, і цим теж не варто розкидатись.
